...
namespace yq {
    ...
    */  // TODO shift to std::string, and move more of these to  yq::string namespace
    ...
    public:
        ...
        */  
        void                blank_cpp_comments();           // to util
        
        String              capitalize() const;             // to util
        
        size_t              char_count() const;             // to util
        
        size_t              count_of(char32_t) const;       // to util?
        ...
        */
        ...
        // TO UTIL....      simplify_string( string )
        ...
        */
        ...
        String              trimmed() const;    // TODO ... yq::string::trim() ... returns std::string_view
...
namespace std {
    ...
    */
    template<> 
    struct hash<yq::String> : public hash<std::string> {
    };
}

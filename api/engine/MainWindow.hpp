...
namespace yq {
    ...
    /*! \brief A basic window
        ...
        a Vulkan instance.
    */
    class MainWindow : public Object, public RefCount, trait::not_copyable, trait::not_moveable {
        YQ_OBJECT_INFO(WindowInfo)
        YQ_OBJECT_DECLARE(MainWindow, Object)
    public:
        ...
        MainWindow(const WindowCreateInfo& i = WindowCreateInfo());

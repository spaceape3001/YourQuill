...
namespace yq {
    ...
    using Coord6Z   = Coord6<size_t>;
        ...
        // COLLECTIONS
    template <typename I, uint8_t N, bool ORIGIN, bool GHOST> struct ArrayCoord;
    
    template <typename I> using BasicAC1    = ArrayCoord<I, 1, false, false>;
    template <typename I> using BasicAC2    = ArrayCoord<I, 2, false, false>;
    template <typename I> using BasicAC3    = ArrayCoord<I, 3, false, false>;
    template <typename I> using BasicAC4    = ArrayCoord<I, 4, false, false>;
    template <typename I> using BasicAC5    = ArrayCoord<I, 5, false, false>;
    template <typename I> using BasicAC6    = ArrayCoord<I, 6, false, false>;
    
    template <typename I> using GhostAC1    = ArrayCoord<I, 1, true, true>;
    template <typename I> using GhostAC2    = ArrayCoord<I, 2, true, true>;
    template <typename I> using GhostAC3    = ArrayCoord<I, 3, true, true>;
    template <typename I> using GhostAC4    = ArrayCoord<I, 4, true, true>;
    template <typename I> using GhostAC5    = ArrayCoord<I, 5, true, true>;
    template <typename I> using GhostAC6    = ArrayCoord<I, 6, true, true>;
    
    template <typename I> using OriginAC1   = ArrayCoord<I, 1, true, false>;
    template <typename I> using OriginAC2   = ArrayCoord<I, 2, true, false>;
    template <typename I> using OriginAC3   = ArrayCoord<I, 3, true, false>;
    template <typename I> using OriginAC4   = ArrayCoord<I, 4, true, false>;
    template <typename I> using OriginAC5   = ArrayCoord<I, 5, true, false>;
    template <typename I> using OriginAC6   = ArrayCoord<I, 6, true, false>;

...
namespace yq::mithril {
    bool            search(WebSearcher<Fragment>&ws, directory_t)
    {
    ...
    bool            search(WebSearcher<Fragment>&ws, document_t)
    {
    ...
    bool            search(WebSearcher<Fragment>&ws, folder_t)
    {
    ...
    bool            search(WebSearcher<Fragment>&ws, parent_t)
    {
        const RootDir*  rt  = arg::root_dir(ws.ctx, "root");
    ...
    bool            search(WebSearcher<Fragment>&ws, root_t)
    {
    ...
    FragmentVector  search(WebContext&ctx, fragment_t)
    {

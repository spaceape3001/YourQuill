...
namespace yq::mithril {
    bool            search(WebSearcher<Directory>&ws, folder_t)
    {
    ...
    bool            search(WebSearcher<Directory>&ws, parent_t)
    {
    ...
    bool            search(WebSearcher<Directory>&ws, root_t)
    {
    ...
    DirectoryVector  search(WebContext&ctx, directory_t)
    {

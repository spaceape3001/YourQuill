...
namespace yq::mithril {
    ...
    public:
        ...
        FunctionalFileNotifier(ChangeFlags ch, const FileSpec& spec, int _order, std::function<void()> handler, const std::source_location&sl) :
    ...
    {
        return FileNotifier::Writer{new FunctionalFileNotifier(ALL, spec, 0, fn, sl)};
    }
}

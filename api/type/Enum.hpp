...
public:
    ...
    bool        operator==(const EnumImpl& rhs) const;
    bool        operator!=(const EnumImpl& rhs) const;
    bool        operator==(typename E::enum_t rhs) const;
    bool        operator!=(typename E::enum_t rhs) const;
    bool        operator<(const EnumImpl& rhs) const;
...
template <typename E>
bool    EnumImpl<E>::operator==(const EnumImpl& rhs) const
{
    return E::m_value == rhs.m_value;
}

...
namespace yq {
    namespace cdb {
        ...
        AttributeVector   attributes(Document d)
        {
        ...
        AttributeVector   child_attributes(Attribute a)
        {

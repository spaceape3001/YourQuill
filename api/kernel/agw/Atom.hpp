...
namespace yq {
    namespace agw {    // short for association web graph... ie, the atoms/classes/fields/properties
        ...
        */
        struct Atom {
            ...
            */
            static AtomVector   all(Sorted sorted=Sorted{});
            ...
            /*! \brief Returns all atoms in the cache database for given class
                ...
                \return std::vector of the found atoms
            */
            static AtomVector   all(Class cls, Sorted sorted=Sorted{});
            ...
            /*! \brief Returns all atoms in the cache database in the given document
                ...
                \return std::vector of the found atoms
            */
            static AtomVector   all(Document doc, Sorted sorted=Sorted{});
            ...
            /*! \brief Returns all atoms in the cache database with the given tag
                ...
                \return std::vector of the found atoms
            */
            static AtomVector   all(Tag tag, Sorted sorted=Sorted{});
            ...
            */
            ...
            /*! Gets all atoms with the specified name
                ...
                \param[in] sorted   Yes/no for sorting by key (default is no)
            */
            static AtomVector    named(std::string_view n, Sorted sorted=Sorted{});
            ...
            */
            ...
            /*! \brief Children of atom
                \param[in] sorted   Yes/no for sorting by key (default is no)
            */
            AtomVector   children(Sorted sorted=Sorted{}) const;
            ...
            /*! \brief Classes of the atom
                \param[in] sorted   Yes/no for sorting by key (default is no)
            */
            ClassVector  classes(Sorted sorted=Sorted{}) const;

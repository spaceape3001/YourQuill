...
YQ_TYPE_IMPLEMENT(yq::agw::Atom)

namespace yq {
    namespace agw {
        AtomVector   Atom::all(Sorted sorted)
        {
        ...
        AtomVector   Atom::all(Class cls, Sorted sorted)
        {
            static const auto& oracle   = wksp::oracle();
            switch(oracle.type){
            case Oracle::DB:
        ...
        AtomVector   Atom::all(Document doc, Sorted sorted)
        {
            static const auto& oracle   = wksp::oracle();
            switch(oracle.type){
            case Oracle::DB:
        ...
        AtomVector   Atom::all(Tag tag, Sorted sorted)
        {
            static const auto& oracle   = wksp::oracle();
            switch(oracle.type){
            case Oracle::DB:
        ...
        bool                Atom::is(Class cls) const
        {
            ...
            switch(oracle.type){
            case Oracle::DB:
                return cdb::is_of_class(*this, cls);
            case Oracle::CURL:  // TODO
            case Oracle::NONE:
            default:
                return false;

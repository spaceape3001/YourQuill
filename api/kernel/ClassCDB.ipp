...
namespace yq {
    namespace cdb {
        ...
        namespace {
            ClassVector           def_derived_sorted(Class c)
            {   
            ...
            ClassVector           def_derived_unsorted(Class c)
            {   
        ...
        ClassVector                def_derived(Class c, Sorted sorted)
        {
        ...
        namespace {
            ClassVector        def_reverse_sorted(Class c)
            {
            ...
            ClassVector        def_reverse_unsorted(Class c)
            {
        ...
        ClassVector           def_reverse(Class c, Sorted sorted)
        {   
            return sorted ? def_reverse_sorted(c) : def_reverse_unsorted(c);
        }
        
        namespace {
            ClassVector        def_source_sorted(Class c)
            {
            ...
            ClassVector        def_source_unsorted(Class c)
            {
        ...
        ClassVector           def_source(Class c, Sorted sorted)
        {
        ...
        ClassVector           def_target(Class c, Sorted sorted)
        {
        ...
        ClassVector       reverses(Class c, Sorted sorted)
        {

...
namespace yq {
    namespace cdb {
        ...
        */
        ...
        AtomVector             children(Atom a,Sorted sorted=Sorted{});
        ...
        [[deprecated]] bool         is(Atom,Class);
        
        //! TRUE if atom has been tagged with given tag
        [[deprecated]] bool         is(Atom,Tag);
        ...
        */
        ...
        //! Tags for atom
        TagVector       tags(Atom,Sorted sorted=Sorted{});

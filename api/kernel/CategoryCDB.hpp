...
namespace yq {
    ...
    using CatFragDocVector  = std::vector<CatFragDoc>;
    ...
    namespace cdb {
        ...
        */
        ...
        CatFragDocVector       reads(Category, cdb_options_t opts=0);
        //! Fragments for the category under specified root
        CatFragDocVector       reads(Category, class Root*, cdb_options_t opts=0);
